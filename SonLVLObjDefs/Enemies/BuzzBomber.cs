		...
		public override void Init(ObjectData data)
		{
			...
			switch (LevelData.StageInfo.folder[LevelData.StageInfo.folder.Length-1])
			{
				...
				default:
					...
					frames[0] = new Sprite(sheet.GetSection(98, 74, 45, 19), -24, -9);
					frames[1] = new Sprite(sheet.GetSection(144, 79, 35, 8), -18, -15);
					break;
				case '2':
					sheet = LevelData.GetSpriteSheet("MZ/Objects.gif");
					frames[0] = new Sprite(sheet.GetSection(1, 127, 45, 19), -24, -9);
					frames[1] = new Sprite(sheet.GetSection(38, 147, 35, 8), -18, -15);
					break;
				case '3':
					sheet = LevelData.GetSpriteSheet("SYZ/Objects.gif");
					frames[0] = new Sprite(sheet.GetSection(1, 81, 45, 19), -24, -9);
					frames[1] = new Sprite(sheet.GetSection(38, 101, 35, 8), -18, -15);
					break;
				case '7':
					sheet = LevelData.GetSpriteSheet("MBZ/Objects.gif");
					frames[0] = new Sprite(sheet.GetSection(1, 1, 45, 19), -24, -9);
					frames[1] = new Sprite(sheet.GetSection(38, 21, 35, 8), -18, -15);
					break;
			}

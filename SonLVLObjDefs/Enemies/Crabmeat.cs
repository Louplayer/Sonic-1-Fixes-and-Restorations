	...
	class Crabmeat : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			switch (LevelData.StageInfo.folder[LevelData.StageInfo.folder.Length-1])
			{
				...
				default:
					sprite = new Sprite(LevelData.GetSpriteSheet("GHZ/Objects.gif").GetSection(138, 157, 42, 31), -21, -15);
					break;
				case '3':
					sprite = new Sprite(LevelData.GetSpriteSheet("SYZ/Objects.gif").GetSection(184, 1, 42, 31), -21, -15);
					break;
				case '7':

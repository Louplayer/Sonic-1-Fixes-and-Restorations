	...
	class Chopper : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			if (LevelData.StageInfo.folder.EndsWith("Zone07"))
				sprite = new Sprite(LevelData.GetSpriteSheet("MBZ/Objects.gif").GetSection(106, 81, 30, 32), -16, -16);
			else
				sprite = new Sprite(LevelData.GetSpriteSheet("GHZ/Objects.gif").GetSection(98, 94, 30, 32), -16, -16);
